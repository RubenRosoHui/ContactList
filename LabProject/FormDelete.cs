            ...
            if (rdbtnSchool.Checked)
            {
                ...
                else if(save)
                {
                    ...
                    { 
                        ...
                        connect.Open();
                        string sqlDelete = "DELETE FROM School WHERE SchoolID = " + SchoolID + " AND SchoolName = '" + SchoolName + "'AND SchoolAddress = '" + SchoolAddress + "' AND SchoolPhone = '"+SchoolPhone+"' AND CourseID = "+CourseID+"";
                        da.DeleteCommand = new OleDbCommand(sqlDelete, connect);
            ...
            if (rdbtnCourse.Checked)
            {
                ...
                else if(save)
                {
                    ...
                    {  
                        ...
                        OleDbConnection connect = new OleDbConnection(constr);
                        connect.Open();
                        string sqlDelete = "DELETE FROM Courses WHERE CourseID = " + CourseID + " AND CourseName = '" + CourseName + "'AND CourseCode = '" + CourseCode + "' AND CourseFee = " + CourseFee + " AND CourseLocation = '" + CourseLocation + "'";
                        da.DeleteCommand = new OleDbCommand(sqlDelete, connect);
                        da.DeleteCommand.ExecuteNonQuery();
                        connect.Close();
